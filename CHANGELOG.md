...
- Switch font for Read-only mode (to make a clear difference with edit mode)

### Improvements:

- Menu to toggle and customize Navigation and Reading modes
- Option to hide all UI elements in Focus mode
- Options to change opacity and position of Navigation controls
